...
VALID_DIR = os.path.join(os.getcwd(), 'valid_dataset')
...
if __name__ == '__main__':
    ...
    X_train1, X_valid1, y_train1, y_valid1 = load_data(TRAIN_DIR, VALID_DIR,
                                                       command_flag='left')
    X_train2, X_valid2, y_train2, y_valid2 = load_data(TRAIN_DIR, VALID_DIR,
                                                       command_flag='straight')
    X_train3, X_valid3, y_train3, y_valid3 = load_data(TRAIN_DIR, VALID_DIR,
                                                       command_flag='right')
